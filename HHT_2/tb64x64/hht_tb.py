...
sparsity = ['64_hht2_tb_10.sv', '64_hht2_tb_20.sv',
			'64_hht2_tb_30.sv', '64_hht2_tb_40.sv',
			'64_hht2_tb_50.sv', '64_hht2_tb_60.sv',
			'64_hht2_tb_70.sv', '64_hht2_tb_80.sv',
			'64_hht2_tb_90.sv']
dat_files = ['hht2_64_10.dat', 'hht2_64_20.dat',
			 'hht2_64_30.dat', 'hht2_64_40.dat',
			 'hht2_64_50.dat', 'hht2_64_60.dat',
			 'hht2_64_70.dat', 'hht2_64_80.dat',
			 'hht2_64_90.dat']
size = 64
val = size*size
...
for x in range(0,9):
	...
	file1.write  ("reg [31:0]wdata_col_base,row_base,matrix_base; \n")  
	...
	file1.write ("control t1 (Clk,v_values_base,wdata_col_base,matrix_base,addr1,addr2,dataIn1,dataIn2,Rst,row_base,RD,csize);  ") 
	...
	file1.write ("  matrix_base = 32'd")
	matrix_end = 5*(2+size)+col_ind
	file1.write  (str(5*(2+size)))
	file1.write  (" ; \n")
	file1.write ("  wdata_col_base = 32'd")
	file1.write  (str(10*matrix_end))
	col_end =    (10*matrix_end+col_ind)
	file1.write  (" ; \n")
	file1.write  ("  row_base = 32'd")
	file1.write  (str(10*col_end))
	file1.write  (" ; \n")
	...
	for y in range(10*col_end,10*col_end +size+1):
	#row
		file1.write("32'd")
		file1.write(str(y))
		file1.write(": dataIn1 = 32'd")
		file1.write(str(file2.readline()))
		file1.write("; \n")
	file2.close()	
	file1.write ("default:  \n")
	...
	file2 = open(dat_files[x], 'r')
	for y in range(10*matrix_end,(10*matrix_end+col_ind)):
	#col
		file1.write("32'd")
		file1.write(str(y))
		file1.write(": dataIn1 = 32'd")
	...
	for y in range(5*(2+size),5*(2+size)+col_ind):
	#matrix
		file1.write("32'd")
		file1.write(str(y))
		file1.write(": dataIn2 = 32'd")
