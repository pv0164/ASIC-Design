...
#       link design
#####################################################################
set search_path 	"..home/STUDENTS/pv0164/hht_rtl/matrix/cpu . "
...
read_vcd  "685_bus.vcd" -strip_path "testbench/t1"
...
report_power -verbose -hierarchy > saif/saif_hht2_685_bus.rpt
...
#sh vcd2saif -input hht_synth.vcd -output hht_synth.saif
#read_saif "hht_synth.saif" -strip_path "testbench/t1"
read_vcd  "jpwh.vcd" -strip_path "testbench/t1"
#report_switching_activity -list_annotated
...
update_power
#set_power_analysis_options -waveform_format fsdb -waveform_output vcd
report_power -verbose -hierarchy > saif/saif_hht2_jpwh.rpt
...
#sh vcd2saif -input hht_synth.vcd -output hht_synth.saif
#read_saif "hht_synth.saif" -strip_path "testbench/t1"
read_vcd  "rbsa.vcd" -strip_path "testbench/t1"
#report_switching_activity -list_annotated
...
update_power
#set_power_analysis_options -waveform_format fsdb -waveform_output vcd
report_power -verbose -hierarchy > saif/saif_hht2_rbsa.rpt
